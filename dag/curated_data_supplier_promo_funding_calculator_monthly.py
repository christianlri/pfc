...
dag_id_prefix = 'curated-data-supplier-promo-funding-calculator-monthly'
...
with DAG(
        ...
        schedule=set_schedule_interval(config, dag_id_prefix, '30 11 1 * *'), # DO NOT change the schedule of this pipeline, without assessing the tasks.
